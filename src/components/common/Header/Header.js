          ...
          <Container>
            ...
            <Collapse isOpen={this.state.isOpen} navbar>
              <Nav className="navbar-nav ml-auto">
                <NavItem>
                  <NavLink tag={RRNavLink} className="nav-link" to="/">Posts</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink tag={RRNavLink} className="nav-link" to="/series">Series</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink tag={RRNavLink} className="nav-link" to="/topic">Topic</NavLink>
                </NavItem>
                <NavItem>
